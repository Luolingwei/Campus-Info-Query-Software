...
namespace Whu038
{
    ...
    public sealed class ShortPathSolveCommand : BaseCommand
    {
        ...
        public override void OnClick()
        {
            ...
            string name = NetWorkAnalysClass.getPath(path) + "\\data\\大实习.gdb";
            IFeatureWorkspace pFWorkspace = NetWorkAnalysClass.OpenWorkspace(name) as IFeatureWorkspace;
            //"RouteNetwork", "BaseData"参数不可更改
            //networkDataset = NetWorkAnalysClass.OpenPathNetworkDataset(pFWorkspace as IWorkspace, "network_ND", "test");
            networkDataset = NetWorkAnalysClass.OpenPathNetworkDataset(pFWorkspace as IWorkspace, "道路_ND", "道路");
